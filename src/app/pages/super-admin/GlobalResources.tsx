...
export function GlobalResources() {
  ...
  const getResourceStyles = (seed: string) => {
    ...
    return {
      ...
      iconBg: `bg-gradient-to-br ${theme.iconBg}`,
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          onClick={() => navigate("/super-admin/resources/create")}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {resourceList.map((resource, index) => {
          ...
          const styles = getResourceStyles(resource.name);
          return (
            <motion.div
              key={resource.id}
            ...
            >
              ...
              <div className="flex items-start justify-between relative z-10">
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 ${styles.iconBg} rounded-2xl flex items-center justify-center`}>
